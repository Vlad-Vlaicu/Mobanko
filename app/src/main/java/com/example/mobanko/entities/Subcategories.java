...
public enum Subcategories {
    ...
    public static Set<Subcategories> getSubcategories(Categories categories) {
        return switch (categories) {
            case LIVING_N_ENERGY ->
                    Set.of(RENT, HOUSE_LOAN, ENERGY, UTILITY_BILLS, WASTE_DISPOSAL, SEWER_FEES, INSURANCE,
                            IMPROVEMENTS_N_FURNITURE, CLEANING, PET_CARE, PROPERTY_INSURANCE, PERSONAL_ITEM_INSURANCE, OTHER_LIVING_N_ENERGY);
            case FOOD_N_DINING -> Set.of(GROCERIES, RESTAURANT_CAFE, OTHER_FOOD);
            case HEALTH_N_SELFCARE ->
                    Set.of(DRUGSTORE, PHARMACY_N_HEALTHCARE, COSMETICS_N_EYE_CARE, DOCTORS_N_HOSPITAL,
            ...
            case CLOTHING_N_SHOES -> Set.of(FASHION, SHOES, ACCESSORIES);
            case COMMUNICATION_N_MEDIA ->
                    Set.of(PHONE_BILLS, TELEVISION, INTERNET, ENTERTAINMENT_ELECTRONICS);
            case LEISURE_N_HOBBIES ->
                    Set.of(AMUSEMENT, HOBBIES, READING, TOYS_N_GAMES, TOBACCONIST, BETTING, OTHER_LEISURE_N_HOBBIES);
            case EDUCATION -> Set.of(SCHOOL, BOOKS_N_SUPPLIES, TUITION, OTHER_EDUCATION);
            case CAR ->
                    Set.of(PURCHASE_LOAN, GAS_N_FUEL, MAINTENANCE_N_SERVICE, INSURANCE, PARKING, VIGNETTE_TOLLS, OTHER_CAR_EXPENSES);
            case PUBLIC_TRANSPORT_N_TAXI ->
                    Set.of(PUBLIC_TRANSPORT, TAXI, OTHER_TRANSPORT_EXPENSES);
            case HOLIDAYS_N_TRAVEL ->
                    Set.of(ACCOMMODATION, FOOD_DRINKS, TRAVEL_EXPENSES, FOREIGN_CURRENCIES, TRAVEL_INSURANCE,
                            OTHER_HOLIDAY_EXPENSES);
            case WITHDRAWAL ->
                    Set.of(ATM_WITHDRAWAL, BRANCH_WITHDRAWAL, CREDIT_CARD_WITHDRAWAL, CREDIT_CARD_BILL, QUICK_TOP_UPS,
                            CASH_WITHDRAWAL, OTHER_CASH);
            case ALIMONY_N_POCKET_MONEY ->
                    Set.of(ALIMONY, POCKET_MONEY, PRIVATE_CONTRIBUTION, OTHER);
            case ONLINE_SHOPS ->
                    Set.of(AMAZON, GOOGLE, ONLINE_SHOPS, WEB_SERVICES, UNCATEGORIZED_ONLINE_SHOPS);
            case SAVING_N_INVESTMENT ->
                    Set.of(SAVINGS, BUILDING_SOCIETY, CAPITALIZATION_PRODUCTS, SECURITIES, CRYPTOCURRENCIES,
                            INVESTMENT_PLAN, NOBLE_METALS, OTHER_SAVINGS);
            case TAXES -> Set.of(PERSONAL_INCOME_TAX, VALUE_ADDED_TAX, OTHER_TAXES);
            case TRANSACTIONS_N_FEES ->
                    Set.of(INTERNAL_TRANSFERS, FEES, INTERESTS, LENDING, EXTERNAL_OWN_TRANSFERS, TAXES, OTHER_FEES);
            case OTHER_EXPENSES ->
                    Set.of(FINANCING, INSURANCE_PREMIUM, SOCIAL_INSURANCE, GIFTS, DONATIONS, PENALTIES_N_GOVERNMENTS,
            ...
            case UNCATEGORIZED_EXPENSES -> Set.of(UNCATEGORIZED);
            case INCOME ->
                    Set.of(SALARY, PENSION, BUSINESS_INCOME, UNEMPLOYMENT, MATERNITY, FAMILY_ALLOWANCE,
                            ALIMONY, OTHER);
            case ADDITIONAL_INCOME ->
                    Set.of(RENTAL, CASH_DEPOSIT, TRAVEL_EXPENSES_OVERTIME, OWN_TRANSFER, ONLINE_SHOPS,
                            REIMBURSEMENTS, INCOME_SAVING_INVESTMENTS, INCOME_INSURANCE, CRYPTO, INVESTMENT_INCOME,
                            SAVINGS_INCOME, OTHER);
            case UNCATEGORIZED_INCOME -> Set.of(OTHER_INCOME);
        };
    }
